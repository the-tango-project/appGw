package org.apeiron.gateway.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("org.apeiron.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("org.apeiron.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
