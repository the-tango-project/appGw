<template>
  <div>
    <h2 id="page-heading" data-cy="FormHeading">
      <span v-text="t$('apeironGwApp.form.home.title')" id="form-heading"></span>
      <div class="d-flex justify-content-end">
        <router-link :to="{ name: 'FormCreate' }" custom v-slot="{ navigate }">
          <button @click="navigate" id="jh-create-entity" data-cy="entityCreateButton" class="btn btn-primary jh-create-entity create-form">
            <span v-text="t$('apeironGwApp.form.home.createLabel')"></span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      ...
      <div class="modal-body">
        <p id="jhi-delete-form-heading" v-text="t$('apeironGwApp.form.delete.question', { id: removeId })"></p>
      </div>
